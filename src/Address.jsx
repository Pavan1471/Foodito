...
import { ArrowLeft, Plus, Check, MapPin, Home, Briefcase, Edit, Trash } from 'lucide-react'
  ...
  const fetchAddresses = async (token) => {
    try {
      ...
      if (response.data.data && response.data.data.length > 0) {
        ...
        const defaultAddress = response.data.data.find((addr) => addr.defaultAddress)
        if (defaultAddress) {
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="section">
              ...
              <div className="address-type-selector">
                <div
                  className={`address-type-option ${formData.addressType === "Home" ? "selected" : ""}`}
                ...
                <div
                  className={`address-type-option ${formData.addressType === "Work" ? "selected" : ""}`}
                ...
                <div
                  className={`address-type-option ${formData.addressType !== "Home" && formData.addressType !== "Work" ? "selected" : ""}`}
            ...
            {addresses.map((address) => (
              ...
              >
                <div className="address-card-header">
                  <div className="address-type-badge">{address.addressType}</div>
                  {address.defaultAddress && <div className="default-badge">DEFAULT</div>}
